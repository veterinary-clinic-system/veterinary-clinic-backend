...
export class InitialSchema1784870708557 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_626b99c8462ae44bf9175e8506" ON "operating_hours" ("branch_id", "day_of_week") `);
        ...
        await queryRunner.query(`CREATE TABLE "doctor_shifts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "doctor_id" uuid NOT NULL, "day_of_week" smallint NOT NULL, "start_time" character varying(5) NOT NULL, "end_time" character varying(5) NOT NULL, "active" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_8c0f510d42bb2948addbdd4021b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_61e26b4fa0e3829ab5d4683cc7" ON "doctor_shifts" ("doctor_id", "day_of_week") `);
        await queryRunner.query(`CREATE TABLE "doctor_breaks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "doctor_id" uuid NOT NULL, "date" date NOT NULL, "start_time" character varying(5) NOT NULL, "end_time" character varying(5) NOT NULL, "reason" character varying(255), CONSTRAINT "PK_934736d89f5264374d905634157" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_e8b49a4dcd3c5888add14a2f5c" ON "doctor_breaks" ("doctor_id", "date") `);
        await queryRunner.query(`CREATE TYPE "public"."doctors_specialization_enum" AS ENUM('GENERAL_PRACTICE', 'INTERNAL_MEDICINE', 'SURGERY', 'THERIOGENOLOGY', 'DERMATOLOGY', 'DENTISTRY', 'DIAGNOSTIC_IMAGING', 'NUTRITION', 'ANESTHESIOLOGY')`);
        ...
        await queryRunner.query(`CREATE TABLE "breeds" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "species_id" uuid NOT NULL, "breed_name" character varying(100) NOT NULL, CONSTRAINT "PK_e89f6e1fbb29d28623b4feb2b3e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."invoices_payment_method_enum" AS ENUM('CASH', 'E_WALLET', 'CREDIT_CARD')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_3717bc742aedb2402c488114c5" ON "inventory_items" ("item_id", "branch_id") `);
        await queryRunner.query(`CREATE TYPE "public"."items_itemtype_enum" AS ENUM('SERVICE', 'MEDICATION', 'LAB_TEST', 'OTHER')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."appointments_priority_color_enum" AS ENUM('RED', 'ORANGE', 'YELLOW', 'GREEN', 'BLUE')`);
        await queryRunner.query(`CREATE TYPE "public"."appointments_commonsymptoms_enum" AS ENUM('SKIN_ALLERGY', 'EAR_INFECTION', 'VOMITING', 'DIARRHEA', 'HEMATURIA', 'LOSS_OF_APPETITE', 'WEIGHT_LOSS', 'HYPERACTIVITY')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_ec296b83c079eb03d3fa611157" ON "appointments" ("doctor_id", "start_at") `);
        await queryRunner.query(`CREATE TYPE "public"."pets_gender_enum" AS ENUM('MALE', 'FEMALE', 'HERMAPHRODITE', 'ASEXUAL')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('ADMIN', 'DOCTOR', 'RECEPTIONIST', 'PET_OWNER')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."notifications_type_enum" AS ENUM('APPOINTMENT_REMINDER', 'APPOINTMENT_UPDATED', 'APPOINTMENT_CANCELLED')`);
        await queryRunner.query(`CREATE TYPE "public"."notifications_channel_enum" AS ENUM('SMS', 'ZALO')`);
        ...
        await queryRunner.query(`CREATE TABLE "pre_screening_disease_groups" ("pre_screening_result_id" uuid NOT NULL, "disease_id" uuid NOT NULL, CONSTRAINT "PK_575d35366a5ea8708e7f2c56838" PRIMARY KEY ("pre_screening_result_id", "disease_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_2ebac00ca5ff37dc92e615e352" ON "pre_screening_disease_groups" ("pre_screening_result_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_15c0128d789fd6033fda1fa8d7" ON "pre_screening_disease_groups" ("disease_id") `);
        await queryRunner.query(`ALTER TABLE "operating_hours" ADD CONSTRAINT "FK_f001135bad68e9b53b0299ed364" FOREIGN KEY ("branch_id") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "doctor_shifts" ADD CONSTRAINT "FK_a4a795dca2ff99a71ef436bbb5d" FOREIGN KEY ("doctor_id") REFERENCES "doctors"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "doctor_breaks" ADD CONSTRAINT "FK_46c908f756ddb7f78088d7c9e30" FOREIGN KEY ("doctor_id") REFERENCES "doctors"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "doctors" ADD CONSTRAINT "FK_efbb5ff2cfbc55ca8f22d1006d8" FOREIGN KEY ("branch_id") REFERENCES "branches"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "breeds" ADD CONSTRAINT "FK_0ea3bf7a9569bb26556fb5a7fb2" FOREIGN KEY ("species_id") REFERENCES "species"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "invoices" ADD CONSTRAINT "FK_70757267b44d3b26bd88966908b" FOREIGN KEY ("appointment_id") REFERENCES "appointments"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "invoice_items" ADD CONSTRAINT "FK_f0b6dca088c1c2d694e91d42aab" FOREIGN KEY ("item_id") REFERENCES "items"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "inventory_items" ADD CONSTRAINT "FK_6c06346f7daad6d05f3cdb95026" FOREIGN KEY ("item_id") REFERENCES "items"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "inventory_items" ADD CONSTRAINT "FK_687d174ee41f46d2ee4b0a241ae" FOREIGN KEY ("branch_id") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "services" ADD CONSTRAINT "FK_192cb6d659136046ced7f54ac8b" FOREIGN KEY ("item_id") REFERENCES "items"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pre_screening_results" ADD CONSTRAINT "FK_8847feb0a64995b0fbd5e780ad4" FOREIGN KEY ("appointment_id") REFERENCES "appointments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "medications" ADD CONSTRAINT "FK_e29e6cc28d2df49212bf6db26c7" FOREIGN KEY ("item_id") REFERENCES "items"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "prescription_items" ADD CONSTRAINT "FK_a603d92d4a8459db5fbe45a4aea" FOREIGN KEY ("prescription_id") REFERENCES "prescriptions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "prescription_items" ADD CONSTRAINT "FK_dcb2e6ee4fcd4f07516ea88758d" FOREIGN KEY ("medication_id") REFERENCES "medications"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "prescriptions" ADD CONSTRAINT "FK_132ec5a26296f40be685f079554" FOREIGN KEY ("examination_id") REFERENCES "examinations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "lab_test_orders" ADD CONSTRAINT "FK_9d4aa2090a5a999bbca0d430a4f" FOREIGN KEY ("examination_id") REFERENCES "examinations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "examinations" ADD CONSTRAINT "FK_480e098f91311e993b64da5835b" FOREIGN KEY ("appointment_id") REFERENCES "appointments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "examinations" ADD CONSTRAINT "FK_9d06e775e6214959a566b4ea465" FOREIGN KEY ("doctor_id") REFERENCES "doctors"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "appointments" ADD CONSTRAINT "FK_4cf26c3f972d014df5c68d503d2" FOREIGN KEY ("doctor_id") REFERENCES "doctors"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "appointments" ADD CONSTRAINT "FK_47439f4739409e7e27f2e5444d5" FOREIGN KEY ("pet_id") REFERENCES "pets"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "appointments" ADD CONSTRAINT "FK_2a2088e8eaa8f28d8de2bdbb857" FOREIGN KEY ("service_id") REFERENCES "services"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "appointments" ADD CONSTRAINT "FK_02cbc216c57a5e6faff8ca8f46f" FOREIGN KEY ("booked_by_user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "appointments" ADD CONSTRAINT "FK_33bed51c16e5a48fe204774beaa" FOREIGN KEY ("parent_appointment_id") REFERENCES "appointments"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pets" ADD CONSTRAINT "FK_478d65b6063e614271e7d4bebad" FOREIGN KEY ("breed_id") REFERENCES "breeds"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "pre_screening_disease_groups" ADD CONSTRAINT "FK_2ebac00ca5ff37dc92e615e3526" FOREIGN KEY ("pre_screening_result_id") REFERENCES "pre_screening_results"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "pre_screening_disease_groups" ADD CONSTRAINT "FK_15c0128d789fd6033fda1fa8d71" FOREIGN KEY ("disease_id") REFERENCES "diseases"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "pre_screening_disease_groups" DROP CONSTRAINT "FK_15c0128d789fd6033fda1fa8d71"`);
        await queryRunner.query(`ALTER TABLE "pre_screening_disease_groups" DROP CONSTRAINT "FK_2ebac00ca5ff37dc92e615e3526"`);
        ...
        await queryRunner.query(`ALTER TABLE "appointments" DROP CONSTRAINT "FK_33bed51c16e5a48fe204774beaa"`);
        await queryRunner.query(`ALTER TABLE "appointments" DROP CONSTRAINT "FK_02cbc216c57a5e6faff8ca8f46f"`);
        ...
        await queryRunner.query(`ALTER TABLE "examinations" DROP CONSTRAINT "FK_9d06e775e6214959a566b4ea465"`);
        await queryRunner.query(`ALTER TABLE "examinations" DROP CONSTRAINT "FK_480e098f91311e993b64da5835b"`);
        await queryRunner.query(`ALTER TABLE "lab_test_orders" DROP CONSTRAINT "FK_9d4aa2090a5a999bbca0d430a4f"`);
        await queryRunner.query(`ALTER TABLE "prescriptions" DROP CONSTRAINT "FK_132ec5a26296f40be685f079554"`);
        ...
        await queryRunner.query(`ALTER TABLE "medications" DROP CONSTRAINT "FK_e29e6cc28d2df49212bf6db26c7"`);
        await queryRunner.query(`ALTER TABLE "pre_screening_results" DROP CONSTRAINT "FK_8847feb0a64995b0fbd5e780ad4"`);
        await queryRunner.query(`ALTER TABLE "services" DROP CONSTRAINT "FK_192cb6d659136046ced7f54ac8b"`);
        ...
        await queryRunner.query(`ALTER TABLE "invoice_items" DROP CONSTRAINT "FK_f0b6dca088c1c2d694e91d42aab"`);
        await queryRunner.query(`ALTER TABLE "invoice_items" DROP CONSTRAINT "FK_dc991d555664682cfe892eea2c1"`);
        await queryRunner.query(`ALTER TABLE "invoices" DROP CONSTRAINT "FK_70757267b44d3b26bd88966908b"`);
        ...
        await queryRunner.query(`ALTER TABLE "doctor_breaks" DROP CONSTRAINT "FK_46c908f756ddb7f78088d7c9e30"`);
        await queryRunner.query(`ALTER TABLE "doctor_shifts" DROP CONSTRAINT "FK_a4a795dca2ff99a71ef436bbb5d"`);
        await queryRunner.query(`ALTER TABLE "operating_hours" DROP CONSTRAINT "FK_f001135bad68e9b53b0299ed364"`);
